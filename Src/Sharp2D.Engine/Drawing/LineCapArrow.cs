...
// Type: Sharp2D.Engine.Drawing.LineCapArrow
...
namespace Sharp2D.Engine.Drawing
{
  internal class LineCapArrow : LineCapInfo
  {
    ...
    private static readonly short[] IndexBuffer = new short[9]
    {
      (short) 0,
      (short) 2,
      (short) 1,
    ...
    public LineCapArrow(float width)
      : base(width, LineCapArrow.XYBuffer, LineCapArrow.UVBuffer, LineCapArrow.IndexBuffer, LineCapArrow.OutlineBuffer)
    {
    }
  }
}
