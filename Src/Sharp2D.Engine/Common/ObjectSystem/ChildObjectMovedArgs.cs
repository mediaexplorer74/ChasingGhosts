...
// Type: Sharp2D.Engine.Common.ObjectSystem.ChildObjectMovedArgs
...
{
  /// <summary>Child Object Moved event arguments.</summary>
  public class ChildObjectMovedArgs
  {
    /// <summary>
