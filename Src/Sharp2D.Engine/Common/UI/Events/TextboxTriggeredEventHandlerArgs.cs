...
// Type: Sharp2D.Engine.Common.UI.Events.TextboxTriggeredEventHandlerArgs
...
namespace Sharp2D.Engine.Common.UI.Events
{
  ...
  /// </param>
  public delegate void TextboxTriggeredEventHandlerArgs(object sender, TextboxTriggeredEventArgs e);
}
